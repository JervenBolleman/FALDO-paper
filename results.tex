...
require relatively simple locations within protein sequences to be described (see figure \ref{fig:UniProt}).
...
Converting more recent curated INSDC data has been straightforward, however there are a

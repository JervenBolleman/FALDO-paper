...
such as UniProt\cite{UniProt2013}, DDBJ\cite{DDBJ2013} (part of the INSDC partnership with the NCBI-GenBank\cite{ENA2013} and EMBL-Bank\cite{GenBank2013}),
and a number of glycomics databases \textit{(TODO - which ones? introduce later? e.g.
 ...
 and UniCarbKB)} and assorted open source developers during these meetings

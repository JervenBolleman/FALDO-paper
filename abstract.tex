...
\item[Description]
We developed a ontology, Feature Annotation Location Description Ontology (FALDO), to describe the positions of annotated features 
...
At the same time the ontology is expressive enough to describe the locations of features on linear and circular sequence accurately.
\end{description}
\end{abstract}

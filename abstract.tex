...
\item[Conclusions] This standard ontology allows users to merge sequence annotation from multiple sources using federalised SPARQL queries against public endpoints and local private datasources. At the same time the ontology is expressive enough to describe all known biological use cases accuratly.
\end{description}
\end{abstract}

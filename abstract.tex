...
\item[Conclusions]
Our ontology allows users to uniformally decribe -- and potentially merge -- sequence annotations from multiple sources. Data sources using FALDO can prospectively be retrieved using federalised SPARQL queries against public SPARQL endpoints and/or local private triple stores.
\end{description}
\end{abstract}

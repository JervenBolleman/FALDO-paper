...
\item[Description]
We developed a ontology, Feature Annotation Location Description Ontology (FALDO), to describe the positions of annotated features on linear and circular sequence accurately.
It is usable for describing nucleotide features in sequence records, protein annotation and glycan binding sites.
...
\item[Conclusions]
This ontology allows users to merge sequence annotation from multiple sources using federalised SPARQL queries against public endpoints and local private datasources.
\end{description}
\end{abstract}

...
FALDO is a small OWL2 ontology with 14 classes, 9 of these deal with the concept of a position on a sequence (Figure \ref{fig:ontology}).
...
The ninth class is the concept of a region i.e. something with a end and start position.
